        ...
        <div className="space-y-4 w-full max-w-lg">
          ...
          <div className="grid grid-cols-1 gap-4">
            <Link
              ...
              href="/wine/winedetail"
            >
              <img
                alt="Sake"
                className="aspect-square rounded-lg object-cover"
                height="100"
                src="https://sakeapp.s3.ap-northeast-1.amazonaws.com/cocktail/wine.jpeg"
                width="100"
              />
              <div className="min-w-0 flex-1 ">
                <h2 className="font-semibold w-screen px-4">wine 1</h2>
            ...
            >
              ...
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold w-1/2 px-4">wine 2</h2>
            ...
            >
              ...
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold flex-grow px-4">wine3</h2>
            ...
            >
              ...
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold flex-grow px-4">wine4</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 flex-grow px-4">
                  ワインの説明
                </p>
              </div>
