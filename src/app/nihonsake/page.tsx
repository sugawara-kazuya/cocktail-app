        ...
        <div className="space-y-4 w-full max-w-lg">
          ...
          <div className="grid grid-cols-1 gap-4">
            <Link
              ...
              href="/nihonsake/nihondetail"
            >
              <img
                alt="Sake"
                className="aspect-square rounded-lg object-cover"
                height="100"
                src="https://sakeapp.s3.ap-northeast-1.amazonaws.com/nihonsake/yamamoto.jpeg"
                width="100"
              />
              <div className="min-w-0 flex-1 ">
                <h2 className="font-semibold w-screen px-4">
                  山本 ピュアブラック 純米吟醸
                </h2>
            ...
            >
              <img
                ...
                className="aspect-square rounded-lg object-cover"
                height="100"
                src="https://sakeapp.s3.ap-northeast-1.amazonaws.com/nihonsake/jikon.jpeg"
                width="100"
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold w-1/2 px-4">而今 特別純米 火入</h2>
            ...
            >
              <img
                ...
                className="aspect-square rounded-lg object-cover"
                height="100"
                src="https://sakeapp.s3.ap-northeast-1.amazonaws.com/nihonsake/hiroki.jpeg"
                width="100"
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold flex-grow px-4">
                  飛露喜 純米大吟醸
                </h2>
            ...
            >
              <img
                ...
                className="aspect-square rounded-lg object-cover"
                height="100"
                src="https://sakeapp.s3.ap-northeast-1.amazonaws.com/nihonsake/denshu.jpeg"
                width="100"
              />
              <div className="min-w-0 flex-1">
                <h2 className="font-semibold flex-grow px-4">
